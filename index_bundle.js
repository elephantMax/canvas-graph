...
/* harmony export */ });
/* harmony import */ var _CanvasElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _Line__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);


class Dot extends _CanvasElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static dots = [];
  ...
  static connectDots() {
    const dots = [...Dot.dots].sort((a, b) => a.x > b.x ? 1 : b.x > a.x ? -1 : 0);
    dots.forEach(dot => {
      const next = dot.getClosestRight();
      if (!next) return;
      new _Line__WEBPACK_IMPORTED_MODULE_1__["default"](dot.x, dot.y, next.x, next.y);
    });
  }
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _models_Canvas__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _models_Grid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _models_Dot__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _models_Line__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony import */ var _models_Animation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6);
/* harmony import */ var _assets_index_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7);
...
const canvas = new _models_Canvas__WEBPACK_IMPORTED_MODULE_0__["default"]('#canvas', {
  width: CANVAS_WIDTH,
  height: CANVAS_HEIGHT,
  onClick: canvasClickHandler
});
const grid = new _models_Grid__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
const rerenderAll = () => {
  _models_Line__WEBPACK_IMPORTED_MODULE_3__["default"].lines = [];
  _models_Dot__WEBPACK_IMPORTED_MODULE_2__["default"].connectDots();
  canvas.redraw(grid, ..._models_Dot__WEBPACK_IMPORTED_MODULE_2__["default"].dots, ..._models_Line__WEBPACK_IMPORTED_MODULE_3__["default"].lines);
};
...
async function canvasClickHandler(e) {
  ...
  const dotInSelectedPos = _models_Dot__WEBPACK_IMPORTED_MODULE_2__["default"].dots.find(item => item.x === xPos);

  if (dotInSelectedPos) {
    let yPos = dotInSelectedPos.y;
    const step = 5;
    const directionTop = y > dotInSelectedPos.y;
    await _models_Animation__WEBPACK_IMPORTED_MODULE_4__["default"].run(() => {
      yPos = directionTop ? yPos + step : yPos - step;
      const newDot = new _models_Dot__WEBPACK_IMPORTED_MODULE_2__["default"](xPos, yPos);
      rerenderAll();
      newDot.remove();
  ...
  new _models_Dot__WEBPACK_IMPORTED_MODULE_2__["default"](xPos, y);
  rerenderAll();
}
...
clearButton.addEventListener('click', () => {
  canvas.clear();
  _models_Dot__WEBPACK_IMPORTED_MODULE_2__["default"].dots = [];
  _models_Line__WEBPACK_IMPORTED_MODULE_3__["default"].lines = [];
  canvas.drawElement(grid);
});
})();
